...
public class FRFoods {
    ...
    public static final FoodProperties STRONG_GREEN_TEA = (new FoodProperties.Builder()).alwaysEat().effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1800, 1), 1.0F).build();
    public static final FoodProperties STRONG_YELLOW_TEA = (new FoodProperties.Builder()).alwaysEat().effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1800, 1), 1.0F).build();
    public static final FoodProperties STRONG_BLACK_TEA = (new FoodProperties.Builder()).alwaysEat().effect(new MobEffectInstance(MobEffects.POISON, 100, 1), 1.0F).effect(new MobEffectInstance(FREffects.CAFFEINATED, 100, 1), 1.0F).build();
    public static final FoodProperties STRONG_PURULENT_TEA = (new FoodProperties.Builder()).alwaysEat().effect(new MobEffectInstance(MobEffects.WEAKNESS, 300, 1), 1.0F).build();
    public static final FoodProperties STRONG_COFFEE = (new FoodProperties.Builder()).alwaysEat().effect(new MobEffectInstance(FREffects.CAFFEINATED, 3000, 2), 1.0F).build();
    public static final FoodProperties STRONG_APPLE_CIDER = (new FoodProperties.Builder()).alwaysEat().effect(new MobEffectInstance(MobEffects.ABSORPTION, 600, 1), 1.0F).build();
